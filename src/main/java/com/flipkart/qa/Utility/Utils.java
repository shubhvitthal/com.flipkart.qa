...
public class Utils  extends TestBase{
	...
	public static void getscreenshot(WebDriver driver,String websitename) throws IOException {
		...
		File destination =new File("F:\\SOFTWARE TEST PROJECT\\MY PROJECT\\com.flipkart.qa\\Screenshots\\"+websitename+filename);
	...
	public static String datafromexcel(String Sheetname, int row, int colm) throws EncryptedDocumentException, IOException {
		...
		FileInputStream file = new FileInputStream("F:\\SOFTWARE TEST PROJECT\\MY PROJECT\\com.flipkart.qa\\src\\main\\java\\com\\flipkart\\qa\\TestData\\TestingData.xlsx");
